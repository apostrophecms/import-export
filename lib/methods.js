    ...
    generateZipFile(data) {
      return new Promise((resolve, reject) => {
        try {
          ...
          /* const docsBuffer = Buffer.from(data.docs); */
          archive.append(data.docs, { name: 'aposDocs.json' });

          if (data.attachments) {
            /* const attachmentBuffer = Buffer.from(data.attachments); */
            archive.append(data.attachments, { name: 'aposAttachments.json' });
          }
