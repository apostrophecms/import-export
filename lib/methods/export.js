  ...
  return {
    ...
    async exportFile(req, reporting, format, data, expiration) {
      ...
      try {
        ...
        if (format.includeAttachments && result?.attachmentError) {
    ...
    async processAttachments(attachments, addAttachment) {
      ...
      console.log('🚀 ~ processAttachments ~ attachments:', attachments);
      ...
      async function processAttachment([ name, url ]) {
        console.log('🚀 ~ processAttachment ~ [ name, url ]:', [ name, url ]);
        ...
        try {
          ...
          console.log('🚀 ~ processAttachment ~ size:', size);
          ...
          await self.apos.lock.withLock('import-export-copy-out', async () => {
            ...
            console.log('addAttachment', { temp, name, size });
