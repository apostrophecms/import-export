  ...
  const storage = {
    download: async (id) => {
      ...
      try {
        ...
        // NOTE: artifactsPath does not exists, the file will be downloaded
      }
      ...
      try {
        ...
        // NOTE: exportPath does not exists, the file will be downloaded
      }
    ...
    remove: async (id) => {
      ...
      try {
        ...
        // NOTE: Nothing to remove, file or folder does not exists
      }
