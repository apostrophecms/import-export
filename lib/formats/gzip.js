...
module.exports = {
  ...
  async import(exportPath, { docIds } = {}) {
    ...
    console.info(`[gzip] docs read from ${docsPath}`);
    console.info(`[gzip] attachments read from ${attachmentsPath}`);
    console.info(`[gzip] attachment files read from ${attachmentFilesPath}`);
